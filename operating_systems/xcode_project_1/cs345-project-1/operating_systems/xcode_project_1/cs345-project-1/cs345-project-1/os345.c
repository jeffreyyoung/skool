...
{
//    tester= initQueue(tester);
//    enQ(tester, 3, 3);
//    task test = deQpop(tester);
...
static int scheduler()
{
    ...
    //kill this code?
    task highest_priority_task = deQpop(rq);
    if(highest_priority_task.tid != -1)
    {
        enQ(rq, highest_priority_task.tid, highest_priority_task.priority);
    }
